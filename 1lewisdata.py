...
1. **Scrape Data**: Retrieves race results for Lewis Hamilton from the Formula 1 website for each year from 2007 to 2024.
...
for year in range(2007, 2025):
    ...
    post = requests.get(url=f'https://www.formula1.com/en/results/{year}/drivers/LEWHAM01/lewis-hamilton')
...
all.to_sql('lewisdata', con=con, index=False)
